...
//This function loops through each response and when the github username is found then moments.js is used to display when a repo was created and updated
                        $.each(response, function (index) {
                            ...
                            } $("#repos").append("<div class='col-md-12'>"+ "<h1><a href='" + this.url + "'><span class='orange'></span> " + this.name + "</a></h1>" + "<div class='col-md-12'>" + "<p>Created: " + created + "</p>" + "<p>Updated: " + updated + "</p>" + "</div>" + "/""<div class='col-md-12'>" + "<p>" + description + "</p>" + "</div>" + "/""</div>"); }); } else {
			// This section of the code gets all the contents that are within the user id 


                        $("#user").html("<h1 class='center'>USER NOT FOUND</h1>");
             //Otherwise When the first function is not met then this fuction now takes what has been collected and loops it through the response and once the collected information doesnt match the response then the information user not found is displayed on the screen
